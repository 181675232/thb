...
<div class="tab-content">
	...
	<dl>
		<dt>原密码</dt>
		<dd><input type="password" name="password" datatype="*" Class="input normal" sucmsg=" " /> <span class="Validform_checktip">*</span></dd>
	</dl> 
	<dl>
		<dt>新密码</dt>
		<dd><input type="password" name="newpass" datatype="*" Class="input normal" sucmsg=" " /> <span class="Validform_checktip">*</span></dd>
	</dl> 
	<dl>
		<dt>再次输入</dt>
		<dd><input type="password" name="pass" datatype="*" Class="input normal" sucmsg=" " /> <span class="Validform_checktip">*</span></dd>
	</dl> 
	<!-- 
  <dl>
    <dt>性别</dt>
