...
<div class="tab-content">
  ...
  <dl>
	...
	<dl>
	<dt>电话</dt>
		<dd><input type="text" name="phone" value="<?php echo ($phone); ?>"  Class="input normal" datatype="*" sucmsg=" " /><span class="Validform_checktip">*</span></dd>
	</dl>
	<dl>
	<dt>折扣</dt>
		<dd><input type="text" name="discount" value="<?php echo ($discount); ?>" datatype="n1-2" Class="input small"  sucmsg=" " errormsg="折扣范围0-99" value="0" /> <span class="Validform_checktip">*0-99之间的数字,0为不打折</span></dd>
	</dl>
	<dl>
	<dt>均价</dt>
	...
	<dl>
	<dt>广告语</dt>
		<dd><input type="text" name="ads" value="<?php echo ($ads); ?>" Class="input normal" datatype="*" sucmsg=" "  /><span class="Validform_checktip">*</span></dd>
	</dl>
	<dl>
	<dt>地址</dt>
		<dd><input type="text" name="address" value="<?php echo ($address); ?>"  Class="input normal" datatype="*" sucmsg=" "  /><span class="Validform_checktip">*</span></dd>
	</dl>
	<dl>
	<dt>大类</dt>
		<dd>
			<div class="rule-single-select">
				<select id="ddlParentId3" name="groupid">
					<option value="0">请选择所属大类</option>
					<?php if(is_array($group1)): $i = 0; $__LIST__ = $group1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><option value="<?php echo ($val["id"]); ?>" <?php if($val["id"] == $groupid): ?>selected="selected"<?php endif; ?>><?php echo ($val["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
				</select>
			</div>
		</dd>
	</dl> 
    ...
    <dd>
		<div id="checkbox"  class="rule-multi-checkbox  multi-checkbox ">
			<?php if(is_array($group2)): $i = 0; $__LIST__ = $group2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><label><input type="checkbox" Value="<?php echo ($val["id"]); ?>" <?php if(in_array($val['id'],$select)){ ?>checked="checked"<?php } ?> name="subgroup[]" /><?php echo ($val["title"]); ?></label><?php endforeach; endif; else: echo "" ;endif; ?>
    	</div>
	</dd>
  </dl>
  <dl>
    ...
    <dd>
		<div class="rule-multi-checkbox  multi-checkbox ">	
    		<label><input type="checkbox" Value="1" <?php if(in_array(1,$select1)){ ?>checked="checked"<?php } ?> name="tags[]" />惠</label>
      		<label><input type="checkbox" Value="2" <?php if(in_array(2,$select1)){ ?>checked="checked"<?php } ?> name="tags[]" />折</label>
			<label><input type="checkbox" Value="3" <?php if(in_array(3,$select1)){ ?>checked="checked"<?php } ?> name="tags[]" />券</label>
			<label><input type="checkbox" Value="4" <?php if(in_array(4,$select1)){ ?>checked="checked"<?php } ?> name="tags[]" />联</label>
			<label><input type="checkbox" Value="5" <?php if(in_array(5,$select1)){ ?>checked="checked"<?php } ?> name="tags[]" />P</label>
			<label><input type="checkbox" Value="6" <?php if(in_array(6,$select1)){ ?>checked="checked"<?php } ?> name="tags[]" />wifi</label>
    	</div>
	</dd>
  </dl>
  <dl>
