...
<div class="tab-content">
	<?php if($pid): ?><input type="hidden" name="pid" value="<?php echo ($pid); ?>" /><?php endif; ?>
	<dl>
    <dt>头像</dt>
      <dd>
  ...
  <dl>
    <dt>手机</dt>
    <dd><input type="text" name="phone" datatype="m" nullmsg="请填写手机号码！" errormsg="请输入正确的手机号码！" sucmsg=" " ajaxurl="<?php echo U('Admin/Member/ajax');?>" Class="input normal" /><span class="Validform_checktip">*商家登陆账号</span></dd>
  </dl>
  <dl>
    <dt>用户名</dt>
      <dd><input type="text" name="name" datatype="*" Class="input normal" sucmsg=" " nullmsg="请输入用户名！" /> <span class="Validform_checktip">*</span></dd>
  </dl> 
  <dl>
    <dt>登录密码</dt>
    <dd><input name="password" type="password" Class="input normal" datatype="*6-20" nullmsg="请设置密码" errormsg="密码范围在6-20位之间" sucmsg=" "><span class="Validform_checktip">*</span></dd>
  </dl>
  <dl>
    <dt>确认密码</dt>
    <dd><input name="password1" type="password" Class="input normal" datatype="*" recheck="password" nullmsg="请再输入一次密码" errormsg="两次输入的密码不一致" sucmsg=" "><span class="Validform_checktip">*</span></dd>
  </dl>
  <dl>
    <dt>性别</dt>
    <dd>
  ...
  <dl>
    <dt>地址</dt>
    <dd><input type="text" name="address" Class="input normal" /></dd>
  </dl>
  <!--
