...
<div class="tab-content">
		...
		<dd>
			<div class="rule-single-select">
				<select id="ddlParentId" name="provinceid">
					<option value="0">请选择省级行政单位</option>
					<?php if(is_array($province)): $i = 0; $__LIST__ = $province;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><option value="<?php echo ($val["provinceid"]); ?>" <?php if($val["provinceid"] == $provinceid): ?>selected="selected"<?php endif; ?>><?php echo ($val["province"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
				</select>
			</div>
		</dd>
	</dl>
	<dl>
	<dt>市：</dt>
		<dd><input type="text" name="city" value="<?php echo ($city); ?>" datatype="*" Class="input normal" sucmsg=" " /> <span class="Validform_checktip">*</span></dd>
	</dl> 
  <!-- 
  <dl>
    <dt>性别</dt>
