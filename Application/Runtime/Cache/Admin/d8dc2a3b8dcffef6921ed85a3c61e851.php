    ...
    <div>
        ...
        <div class="toolbar-wrap">
            <div id="floatHead" class="toolbar">
                <div class="l-list">
                    <ul class="icon-list">
                        <li><a class="add" href="<?php echo U('/Admin/Ads/add');?>"><i></i><span> 新增</span></a></li>
						<!--<li><a id="btnSave" Class="save"><i></i><span>保存</span></a></li>-->
                        <li><a class="all" href="javascript:;" onclick="checkAll(this)"><i></i><span>全选</span></a></li>
                        <li><a class="del" style="cursor:pointer;" id="btnDelete" OnClick="return ExePostBack('Ads')"><i></i><span>删除</span></a></li>
                    </ul>
<!--					<div class="menu-list">
		...
		<?php if($data): if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
			    ...
			    <td align="center"><input name="ord" value="<?php echo ($val["ord"]); ?>" Class="sort" style="text-align:center;" onblur="order(<?php echo ($val["id"]); ?>,this.value,'Ads')" /></td>
				<!--
			    <td align="center">
			      <div class="btn-tools">
				...
				-->
			    <td align="center"><a href="/Admin/Ads/edit/id/<?php echo ($val["id"]); ?>">查看/修改</a></td>
