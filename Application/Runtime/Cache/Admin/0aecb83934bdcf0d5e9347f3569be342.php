...
<div class="location">
  ...
  <i class="arrow"></i>
  <a href="/Admin/Ads"><span>幻灯列表</span></a>
  <i class="arrow"></i>
  <span>新增信息</span>
</div>
...
<div class="tab-content">
    ...
    <dt>图片</dt>
      <dd>
      	<img src="" class="upload-img" style="width: 250px; height: 110px;" />
		<input type="hidden" id="txtImgUrl" name="simg" Class="input normal upload-path" />
      	<div style="position:relative; top: -13px; left: 5px;" class="upload-box upload-img"></div><span style="position:relative; top: -13px; left: 5px;" class="Validform_checktip">*建议上传1000:400像素的jpg,png图片</span>
	</dd>
  </dl>
	<dl>
	<dt>标题</dt>
		<dd><input type="text" name="title" Class="input normal" /></dd>
	</dl>
	<dl>
	<dt>排序</dt>
