...
<div class="tab-content">
  ...
  <dl>
    <dt>网站名称</dt>
      <dd><input type="text" name="title" value="<?php echo ($title); ?>" datatype="*" Class="input normal" sucmsg=" " nullmsg="请输入网站名称！" /> <span class="Validform_checktip">*</span></dd>
  </dl>
  <dl>
    <dt>APP版本号</dt>
    <dd><input type="text" name="version" value="<?php echo ($version); ?>"  Class="input normal" /></dd>
  </dl>
  <dl>
    <dt>公司名称</dt>
    <dd><input type="text" name="company" value="<?php echo ($company); ?>"  Class="input normal" /></dd>
  </dl>
  <dl>
    <dt>电话</dt>
    <dd><input type="text" name="tel" value="<?php echo ($tel); ?>"  Class="input normal" /></dd>
  </dl>
  <dl>
    <dt>地址</dt>
    <dd><input type="text" name="addr" value="<?php echo ($addr); ?>" Class="input normal" /></dd>
  </dl>
  <dl>
    <dt>网站关键字(SEO)</dt>
    <dd><input type="text" name="keyword" value="<?php echo ($keyword); ?>" Class="input normal" /></dd>
  </dl>
  <dl>
    <dt>网站描述(SEO)</dt>
    <dd><input type="text" name="description" value="<?php echo ($description); ?>" Class="input normal" /></dd>
  </dl>
  <dl>
    <dt>网站版权信息</dt>
    <dd>
      <textarea id="webcopyright" name="content" Class="input" /><?php echo ($content); ?></textarea>
