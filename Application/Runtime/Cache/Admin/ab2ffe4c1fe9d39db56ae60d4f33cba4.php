...
<div class="location">
  ...
  <i class="arrow"></i>
  <a href="/Admin/Activity"><span>活动列表</span></a>
  <i class="arrow"></i>
  <span>新增信息</span>
</div>
...
<div class="tab-content">
    ...
    <dt>活动正方图片</dt>
      <dd>
      	<img src="" class="upload-img" style="width: 250px; height: 250px;" />
    ...
    <dt>活动长方图片</dt>
      <dd>
      	<img src="" class="upload-img" style="width: 250px; height: 125px;" />
  ...
  <dl>
	<dt>活动商铺编号</dt>
		<dd><input type="text" name="shopid" datatype="n" sucmsg=" " Class="input normal" /><span class="Validform_checktip">*</span></dd>
	</dl>
	<dl>
	<dt>标题</dt>
