    ...
    <div>
        ...
        <div class="toolbar-wrap">
            <div id="floatHead" class="toolbar">
                ...
                <div class="l-list">
                    <ul class="icon-list">
                        <li><a class="add" href="<?php echo U('/Admin/Area/add');?>"><i></i><span> 新增</span></a></li> 
                        <li><a class="all" href="javascript:;" onclick="checkAll(this)"><i></i><span>全选</span></a></li>
                        <li><a class="del" style="cursor:pointer;" id="btnDelete" OnClick="return ExePostBack('Area')"><i></i><span>删除</span></a></li>
                    </ul>
                </div>
				-->
                <div class="r-list">
        ...
        <!--列表-->
		 ...
		 <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td align="center">
                     ...
                     -->
                    <td align="center">
                        <a href="/Admin/Area/edit/id/<?php echo ($val["id"]); ?>">查看/修改</a>
                    </td>
